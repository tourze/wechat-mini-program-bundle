...
trait LaunchOptionsAware
{
     ...
     */
    #[ORM\Column(type: Types::JSON, nullable: true, options: ['comment' => '启动参数'])]
    private ?array $launchOptions = [];

    /**
     * @var array<string, mixed>|null
     */
    #[ORM\Column(type: Types::JSON, nullable: true, options: ['comment' => '进入参数'])]
